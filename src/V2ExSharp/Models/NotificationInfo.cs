...
public class NotificationInfo
{
    ...
    public class NotificationItemInfo
    {
        ...
        {
            get { return $"{this.PreTitle} {this.TopicTitle} {this.PostTitle}"; }
        }

        [XPath("//td//strong")] public string UserName { get; set; } = null!;

        [XPath("//td//strong/..", "href")] public string UserLink { get; set; } = null!;

        [XPath("//td/a/img", "src")] public string Avatar { get; set; } = null!;
