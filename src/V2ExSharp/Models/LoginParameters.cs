...
public partial class RestrictedProblem
{
    [XPath("//title")] [SkipNodeNotFound] public string? DocumentTitle { get; init; }

    [XPath("//div[@id='Main']//div[@class='box']")]
    [SkipNodeNotFound]
    public string? RestrictedContent { get; init; }

    public bool IsRestricted() => DocumentTitle != null && DocumentTitle.Contains("登录受限");
}