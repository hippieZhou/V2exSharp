...
public class NewsInfo
{
    ...
    public class Item
    {
        ...
        [XPath("//td/a/img", "src")] public string Avatar { get; init; } = null!;

        [XPath("//td/a", "href")] public string AvatarLink { get; init; } = null!;

        [XPath("//td/span[1]/strong/a")] public string UserName { get; init; } = null!;
        ...
        {
            get { return this.LastRepliedText == "置顶"; }
        }
        ...
        [XPath("//td/span[1]/a")] public string NodeName { get; init; } = null!;

        [XPath("//td/span[1]/a", "href")] public string NodeLink { get; init; } = null!;
